...
double complex firstPart(int N, int l, int m, double * dVec, double gamma, double Lamda, double qSqur);
//Second part:
...
double complex thirdPart(int N, int l, int m, double * dVec, double gamma, double Lamda, double qSqur);
